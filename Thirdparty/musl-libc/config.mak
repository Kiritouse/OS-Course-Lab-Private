...
# ./configure --prefix=/workspaces/OS-Course-Lab/Lab5/build/chcore-libc --syslibdir=/workspaces/OS-Course-Lab/Lab5/build/chcore-libc/lib --with-malloc=oldmalloc CROSS_COMPILE=aarch64-linux-gnu- COMPILER=aarch64-linux-gnu-gcc CFLAGS='-DCHCORE_ASLR -DCHCORE_CROSS_COMPILE=aarch64-linux-gnu- -DCHCORE_KERNEL_DEBUG -DCHCORE_KERNEL_ENABLE_QEMU_VIRTIO_NET -DCHCORE_PLAT=raspi3 -DCHCORE_SUBPLAT= -DCHCORE_ARCH_AARCH64 -DCHCORE_PLAT_RASPI3 -I/workspaces/OS-Course-Lab/Lab5/user/chcore-libc/libchcore/arch/aarch64' UAPI_INCLUDE=/workspaces/OS-Course-Lab/Lab5/kernel/user-include
...
ASMSUBARCH = 
srcdir = .
prefix = /workspaces/OS-Course-Lab/Lab5/build/chcore-libc
exec_prefix = $(prefix)
bindir = $(exec_prefix)/bin
libdir = $(prefix)/lib
includedir = $(prefix)/include
syslibdir = /workspaces/OS-Course-Lab/Lab5/build/chcore-libc/lib
CC = aarch64-linux-gnu-gcc
CFLAGS = -DCHCORE_ASLR -DCHCORE_CROSS_COMPILE=aarch64-linux-gnu- -DCHCORE_KERNEL_DEBUG -DCHCORE_KERNEL_ENABLE_QEMU_VIRTIO_NET -DCHCORE_PLAT=raspi3 -DCHCORE_SUBPLAT= -DCHCORE_ARCH_AARCH64 -DCHCORE_PLAT_RASPI3 -I/workspaces/OS-Course-Lab/Lab5/user/chcore-libc/libchcore/arch/aarch64
...
LIBCHCORE_A = 
LIBCHCORE_INCLUDE = 
UAPI_INCLUDE = /workspaces/OS-Course-Lab/Lab5/kernel/user-include
LDFLAGS = 
